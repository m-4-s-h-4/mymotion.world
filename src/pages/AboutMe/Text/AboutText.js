    ...
    return (
        <div className={styles.aboutContainer}>
            ...
            <div className={styles.div2}>
                <h3  className={styles.p1}>I'm a frontend developer based in Spain with a passion for motion design. I'm deeply inspired by digital artist Ben Marriott and his compelling storytelling techniques.
